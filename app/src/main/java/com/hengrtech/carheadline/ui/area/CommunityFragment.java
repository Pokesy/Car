...
public class CommunityFragment extends BasicTitleBarFragment {
    ...
    private int[] tabIcons = {
            R.drawable.icon_tab_tucao, R.drawable.icon_tab_question
    };
    ...
    protected void onCreateViewCompleted(View view) {
        ...
        fragments.add(TucaoFragment.newInstance("吐槽"));
        fragments.add(QuestionFragment.newInstance("问答"));
...
//                                                        imIcon.setImageResource(R.mipmap.ic_launcher);
        ...
        imIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("flag", currentItem);
