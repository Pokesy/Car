 ...
 */
public class ZhuanTiActivity extends BasicTitleBarActivity implements OnItemClickListener,
    ...
    public class TodayAdapter extends RecyclerAdapter<InfoModel> {
        ...
        public View createView(LayoutInflater inflater, ViewGroup parent, int viewType) {
            return inflater.inflate(R.layout.zhuanti_list_item, parent, false);
        }
        ...
        public void convert(RecyclerHolder holder, InfoModel item, int position) {
            ...
            ImageLoader.loadOptimizedHttpImage(ZhuanTiActivity.this, item.getCoverArr().get(0))
