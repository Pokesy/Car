...
public class HomeFragment extends BasicTitleBarFragment {
    ...
    protected void onCreateViewCompleted(View view) {
        ...
        fragments.add(InformationFragment.newInstance("资讯"));
        fragments.add(PraiseFragment.newInstance("口碑"));
        fragments.add(WorkFragment.newInstance("作业"));
        fragments.add(MediaFragment.newInstance("自媒体"));
