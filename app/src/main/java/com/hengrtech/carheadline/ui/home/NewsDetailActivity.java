...
public class NewsDetailActivity extends BasicTitleBarActivity implements View.OnClickListener {
    ...
    private void initColectService() {
        ...
        manageRpcCall(mInfo.collectNews(mUserInfo.getMemberId(), newsId, mUserInfo.getToken(),new NewsCollectParams(mUserInfo.getMemberId(), newsId, mUserInfo.getToken())), new UiRpcSubscriber<String>(this) {
            @Override
